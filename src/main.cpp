...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
	...
	if ( (nHeight < 74999) &&  (nHeight > 50000) )
		nSubsidy = 50000 * COIN;
	else if ( (nHeight < 124999) &&  (nHeight > 75000) )
		nSubsidy = 25000 * COIN;
	else if ( (nHeight < 149999) &&  (nHeight > 125000) )
		nSubsidy = 15000 * COIN;
	else if ( (nHeight < 299999) &&  (nHeight > 150000) )
		nSubsidy = 5000 * COIN;
    	else if ( (nHeight < 599999) &&  (nHeight > 300000) )
        	nSubsidy = 2500 * COIN;
    	else if (nHeight < 1199999) && (nHeight > 600000)
        	nSubsidy = 1250 * COIN;
...
static const int64 nTargetTimespan =  1 * 60; // TrollCoin: Every block
static const int64 nTargetSpacing = 1 * 60; // 60 seconds
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    printf(" nActualTimespan = %"PRI64d" before bounds\n", nActualTimespan);        
         ...
         int64 nActualTimespanMax = ((nTargetTimespan*76)/73);
         int64 nActualTimespanMin = ((nTargetTimespan*73)/76);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal TrollCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TrollCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc2, 0xde, 0xd1 }; 
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // trollcoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
